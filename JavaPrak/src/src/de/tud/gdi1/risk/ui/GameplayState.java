...
import src.de.tud.gdi1.risk.actions.AttackAction;
import src.de.tud.gdi1.risk.actions.CancelAction;
import src.de.tud.gdi1.risk.actions.DiceAction;
import src.de.tud.gdi1.risk.actions.EndTurnAction;
import src.de.tud.gdi1.risk.actions.FortifyAction;
import src.de.tud.gdi1.risk.actions.HideMissionAction;
import src.de.tud.gdi1.risk.actions.NextPhaseAction;
import src.de.tud.gdi1.risk.actions.ShowCardAction;
import src.de.tud.gdi1.risk.actions.ShowMissionAction;
import src.de.tud.gdi1.risk.actions.StartFortifyAction;
